CREATE OR REPLACE TABLE `rd-dapj-dev.processed_daimaruyu_data.PDP_20231015_attributes` AS
SELECT 
    d.uuid,
...
FROM `rd-dapj-dev.processed_daimaruyu_data.PDP_20231015_calc` AS d
